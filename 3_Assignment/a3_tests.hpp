...
public:
  bool test1()
  {
    ...
    cout << " ASSERT_TRUE(bst.root_ == NULL); " << endl;
    ASSERT_TRUE(bst.size_ == 0 && bst.size() == 0);
    cout << " ASSERT_TRUE(bst.size_ == 0 && bst.size() == 0); " << endl;
  ...
  bool test2()
  {
    ...
    cout << "ASSERT_TRUE(bst.max() == bst.min() && bst.max() == 5); OK " << endl;
    ASSERT_TRUE(bst.size() == 1);
    cout << "ASSERT_TRUE(bst.size() == 1); OK " << endl;
